...
//   };
// 
//   axios(options).then(res=>showOutput(res.data));
// }
...
function transformResponse() {
  const options = {
    ...
    url: 'https://jsonplaceholder.typicode.com/todos',
    data: {
      title: 'hello world this done with help of array'
    },
    transformResponse: [axios.defaults.transformResponse[0], function (data) {
      data.title = data.title.toUpperCase();
      return data;
    }]
  };
...
function errorHandling() {
  ...
  axios
    .get('https://jsonplaceholder.typicode.com/todos?_limit=5',{ValidityStatus:function(status){
      return status<500;
    }})
    .then(res =>showOutput(res))
    .catch(err=>{
